...
func interact():
	...
	if orb_noise:
		...
		$"../../1_memory/memory3".visible = true
		$"../../1_memory/memory3/AnimationPlayer".play("M_fadein")  # Replace "fade_in" with your actual animation name
